<template>
  ...
  if(props.scrollPer>1&&props.scrollPer<=17)
  {
  //   let h1=document.getElementById("h1");
  //   h1.style="display:none";
    ...
    t.style="display:none";
    curr=Math.round(((props.scrollPer)/17)*27);
    for(i=1;i<=63;i++)
    {
        temp=`h`+(i);
        t=document.getElementById(temp);   
  ...
  else if(props.scrollPer>17&&props.scrollPer<=34)
  {  
  
    t.style="display:none";
    curr=27+Math.round(((props.scrollPer-17)/17)*15);
    for(i=1;i<=63;i++)
    {
        temp=`h`+(i);
        t=document.getElementById(temp);   
  ...
  else if(props.scrollPer>34&&props.scrollPer<=50)
  { 

    t.style="display:none";
    curr=42+Math.round(((props.scrollPer-34)/16.5)*21);
    for(i=1;i<=63;i++)
    {
        temp=`h`+(i);
        t=document.getElementById(temp);   
